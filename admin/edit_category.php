...
// Handle category update if update_category is set in the POST request
    ...
    if ($stmt1->execute()) {
        header("location:list_categorys.php?message=Category updated successfully");
    } else {
        header("location:list_categorys.php?error=Error updating category");
    }
}
        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="list_categorys.php" class="btn btn-primary">Back</a> <!-- Corrected link -->
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
